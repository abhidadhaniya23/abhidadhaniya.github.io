...
let radioBtn = document.getElementsByClassName('ansbtn');
...
function showQuestion() {
    ...
    document.querySelector('.que-no').innerText = `Question ${i + 1} out of ${10}`;
...
function countScore() {
    ...
    // console.log(`Ans of ${temp} : ${json[temp].ans}`);
    // console.log(`input Value : ${inputVal}`);
    // console.log(`${i + 1}. ${json[randomNumber].question}`);
    if (inputVal == `${json[temp].ans}`) {
        score++;
    } else {
        lossScore++;
    }
...
function displayResult() {
    if(score>=7){
        ...
        resultLine=`you got ${(score/10)*100}% in this quiz. &#129323`;
    }
    else if(score<4){
        resultLine=`you got ${(score/10)*100}% in this quiz. &#128563`;
    }
    result = `
    <div class="que-no">Result</div>
                <div class="container">
                    <div class="result">
                        <h3>${score}/${10}</h1>
                        <h5 id="finalScore">${resultLine}</h3>
                        <p id="warningDetails" style="margin: 20px auto 10px;">${sorryLine}</p>
                    </div>
                </div>
                <a id="playAgain" onclick="refreshPage()">Play Again</a>
    `;
    ...
    switch (score) {
        ...
        case 7:
            ...
            break;
        case 6:
            document.getElementById('finalScore').style.color = '#ff8200';
            break;
        case 5:
            document.getElementById('finalScore').style.color = '#ff8200';
            break;
...
function selectedAns() {
    ...
    // console.log(`Input value : ${inputVal}`);
    // console.log(`Your selected ans is : ${inputVal}`);
}